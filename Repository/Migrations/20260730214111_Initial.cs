        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BusinessId = table.Column<Guid>(type: "uuid", nullable: false),
                    TermDurationMinutes = table.Column<int>(type: "integer", nullable: false),
                    LastGeneratedThroughDate = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Terms_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingDays_WorkSchedules_WorkScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_UserId_BusinessId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Terms_BusinessId_Date",
                table: "Terms",
                columns: new[] { "BusinessId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Terms_EmployeeId_Date_StartTime",
                table: "Terms",
                columns: new[] { "EmployeeId", "Date", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkingDays_WorkScheduleId_DayOfWeek",
                table: "WorkingDays",
